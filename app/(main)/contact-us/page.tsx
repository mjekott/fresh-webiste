          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-5 max-w-md">
                ...
                <div className="flex items-center gap-4 border border-gray-300 rounded-lg px-5 py-4 bg-white/60 backdrop-blur-sm">
            ...
            <div className="bg-white/70 backdrop-blur-md shadow-xl rounded-xl p-8 lg:p-10 max-w-lg ml-auto">
              ...
              <form className="space-y-5">
                ...
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full rounded-lg bg-gray-100 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-green-600"
                />
                ...
                <textarea
                  placeholder="Message"
                  rows={5}
                  className="w-full rounded-lg bg-gray-100 px-4 py-3 text-sm outline-none resize-none focus:ring-2 focus:ring-green-600"
                />
