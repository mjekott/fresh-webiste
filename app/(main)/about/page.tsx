  ...
  return (
    <div className="w-full bg-[#F6F7F6]">
      ...
      >
        ...
        <div className="relative w-full md:w-[55%] lg:w-[50%] z-10">
        ...
        <div className="absolute -bottom-32 md:-bottom-40 lg:-bottom-48 right-4 md:right-8 lg:right-16 z-20 mix-blend-multiply">
        ...
        <div className="absolute top-12 right-12 md:top-16 md:right-16 lg:top-20 lg:right-20  rounded-full p-3 md:p-4 shadow-lg z-10">
      ...
      <section className="relative px-4 md:px-12 lg:px-24 pt-48 md:pt-56 lg:pt-64 pb-16 md:pb-24 lg:pb-32 bg-white overflow-visible">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-12 md:mb-16 lg:mb-24">
          Who we <span className="text-orange-500">serve</span>
        </h2>

        
        <div className="hidden lg:block absolute top-32 left-8 opacity-30">
          <Image
            src="/images/about/leaf.png"
            alt="decoration"
            width={60}
        ...
        <div className="relative flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16 mb-16 md:mb-24 lg:mb-32">
          ...
          <div className="relative w-48 h-48 md:w-64 lg:w-80 md:h-64 lg:h-80 rounded-full overflow-hidden shadow-2xl shrink-0 bg-gray-100">
            <Image
              src="/images/about/vendor.png"
        ...
        <div className="hidden lg:block absolute top-[35%] right-8">
          <Image
        ...
        {/* Customers Section */}
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16 mb-16 md:mb-24 lg:mb-32">
          
          <div className="hidden lg:block absolute right-[12%] top-1/2 -translate-y-1/2 w-24 h-24">
            <svg width="120" height="100" viewBox="0 0 120 100" fill="none" className="stroke-green-800">
              <path d="M110 50 Q80 20, 40 30" strokeWidth="3" strokeLinecap="round" fill="none"/>
            </svg>
          </div>

          <div className="w-full md:w-[45%] order-2 md:order-1">
            <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold mb-4 md:mb-6">Customers</h3>
            <p className="text-gray-600 mb-6 md:mb-8 leading-7 md:leading-8 text-sm md:text-base">
              Reach new customers, market your store, and grow your
              business by offering delivery, pickup, and direct online ordering with DoorDash.
            </p>
            ...
            <div className="flex gap-3 md:gap-4 flex-wrap">
              ...
              />
              <Image
                src="/images/about/googleplay.png"
          ...
          <div className="relative w-48 h-48 md:w-64 lg:w-80 md:h-64 lg:h-80 rounded-full overflow-hidden shadow-2xl shrink-0 bg-gray-100 order-1 md:order-2">
            <Image
              src="/images/about/customers.png"
        ...
        <div className="hidden lg:block absolute bottom-32 left-8">
          <Image
